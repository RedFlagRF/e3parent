    ...
    <div id="userAddrId" class="orderTbody ">
        ...
        <div class="orderItem">
            <div class="orderCurr" id="userAddress" style="display:block;">
                <ul>
                    <li>入云龙&nbsp;&nbsp;&nbsp;&nbsp;15800888888&nbsp;&nbsp;&nbsp;&nbsp;北京市&nbsp;&nbsp;昌平区&nbsp;&nbsp;北七家镇
                        修正大厦
                    </li>
                </ul>
            </div>
    ...
    <div class="orderTbody" style="width:958px;border-bottom:0 none;">
                        ...
                        <div class="orderTbl">
                            ...
                            <c:forEach items="${cartList }" var="cart" varStatus="status">
                                <div class="orderPInfo">
                                    <div class="pItem">
                                        <a href="http://item.RedFlag.cn/item/${cart.id}.html" target="_blank">
                                            <img src="${cart.image }" style="width: 60px;height: 60px;"/>
                                        </a>
                                    </div>
                                    <div class="pItem pGoods">
                                        <a href="http://item.RedFlag.cn/item/${cart.id}.html"
        ...
        <div class="orderItem" style="position:relative;padding-top:10px;">
            ...
            <div class="order-info" style="z-index: -1;">
				...
				<fmt:formatNumber value="${totalPrice / 100 }" maxFractionDigits="2" minFractionDigits="2"
                                  groupingUsed="true"/>
			</span></span>
                        </dd>
                        <dd>
            	...
            	<fmt:formatNumber value="${totalPrice / 100 + 10}" maxFractionDigits="2" minFractionDigits="2"
                                  groupingUsed="true"/>
            </span></span>
                        </dd>
                    </dl>
    ...
    <div class="orderTFoot">
        ...
        <div class="submitOrder">
            ...
            <div class="orderAccount">
                ...
                <span class="p">¥</span>
                <span id="countPrice" class="p"><fmt:formatNumber value="${totalPrice / 100 + 10}" maxFractionDigits="2"
