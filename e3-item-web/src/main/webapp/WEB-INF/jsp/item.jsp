            ...
            <div class="pItemsMain">
                ...
                <div class="pItemsPrice" id="price-sf">
                    <div class="priceBox">
                        ...
                        <strong class="price"><fmt:formatNumber groupingUsed="false" maxFractionDigits="2"
                                                                minFractionDigits="2"
            ...
            <div class="commentList" id="commandp">
                ...
                <div class="plpage">
                    ...
                    <div class="pages" id="comment-ajax-page-sf"><span class="prev disabled"><b class="prevarr"></b>上一页</span><span
                            class="current">1</span><span class="next disabled">下一页<b class="nextarr"></b></span></div>
                </div>
            </div>
