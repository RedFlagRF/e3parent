...
public class E3Result implements Serializable {
     ...
     * 插入错误
     */
    public static final int INSERT_ERROR = 601;
    /**
     * 删除错误
     */
    public static final int DEL_ERROR = 602;
    /**
     * 更新错误
     */
    public static final int UPDATE_ERROR = 603;
    /**
     * 查询错误
     */
    public static final int SEARCH_ERROR = 604;
    /**
     * 登陆错误
     */
    public static final int Login_ERROR = 605;
    /**
     * 其他错误
     */
    public static final int OTHER_ERROR = 666;
    // 定义jackson对象
