...
<div id="header">
  <div class="header_inner">
    ...
    <div class="search">
      <form action="http://search.RedFlag.cn/search.html" id="searchForm" name="query" method="GET">
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="http://cart.RedFlag.cn/cart/cart.html" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
